...
private fun findWinningCard(drawInput: List<Int>, bingoCardInput: String): BingoCard {
    ...
    drawInput.forEach { number ->
        ...
        val cardMostLikelyToWin = cardDeck.sortedWith { o1, o2 -> o1.getLikelihoodOfWinning() - o2.getLikelihoodOfWinning() }.last()

        if (cardMostLikelyToWin.isWinningCard()) {
            return cardMostLikelyToWin
        }
    }
